...
// 2. Dictionnaire de correspondance (Libellé du fichier -> Ticker Yahoo Finance)
const TICKER_MAPPING = {
  ...
  'SMH': 'SMH.PA',            // VanEck Semiconductor
  'DAPP': 'DAPP.PA',          // VanEck Crypto Leaders
  ...
  'CW8': 'CW8.PA',            //Amundi MSCI World Swap UCITS ETF EUR Acc
  'PSP5': 'PE500.PA',         //Amundi PEA S&P 500 UCITS ETF Acc
...
// 3. Liste des lignes à ignorer complètement (Liquidités, comptes, etc.)
...
async function generateMonthlyPrices() {
  try {
    ...
    // 4. Extraction et filtrage strict pour éliminer les lignes de virement (VIR) et de cash
